  ...
  <v-app>
    ...
    <v-app-bar app>
      <v-toolbar-title class="headline text-uppercase">
        <img alt="Vue logo" class="topLogo" src="./assets/ball.png">
      </v-toolbar-title>
      <span class="font-weight-light topText">Z.I.G Baseball</span>
      <v-spacer></v-spacer>
      <menu>
        <label for="trigger">
          ...
          <section class="drawer-list">
            <ul>
              <li v-on:click="$router.push('/')"><a>Home</a></li>
              <li v-on:click="$router.push('about')"><a>About</a></li>
              <li v-on:click="$router.push('contact')"><a>Contact</a></li>
            </ul>
          </section>
          <hamburger> <i></i>
            <text>
...
<style>
  ...
  menu .drawer-list {
    ...
    background-color: rgba(13, 97, 176, 0.9);
  }
  ...
  menu .drawer-list li a:hover {
    ...
    background-color: rgba(17, 132, 240, 0.9);
  }
